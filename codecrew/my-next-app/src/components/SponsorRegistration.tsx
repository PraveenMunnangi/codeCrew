// src/components/SponsorRegistration.tsx
"use client";
...
export default function SponsorRegistration({ onSuccess }: SponsorRegistrationProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Thank you for registering as a sponsor!');
      setName("");
      setEmail("");
      onSuccess();
    } catch (err) {
